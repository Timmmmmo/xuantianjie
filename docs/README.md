...
**v7.8.6（已上线）**：入口修复 —— 回访壳收进「修行录」折叠面板，主入口「踏入战场」重回首屏（此前被顶出视口，玩家进不去游戏）。  
**v7.8.5（已上线）**：v7.7 玩法 × 回访壳 × **IAA 预研**（结算×2 / 日课补签 / 去广告 mock）。  
**PM 统筹**：[`docs/PM_OPERATING.md`](docs/PM_OPERATING.md)（创意/设计/Coding/质量/测试门禁）。
